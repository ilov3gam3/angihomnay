(function (r, l) {
    ...
    r.ui = r.ui || {}, r.ui.version || (r.extend(r.ui, {
        ...
        propAttr: r.fn.prop || r.fn.attr, _focus: r.fn.focus, focus: function (e, i) {
            ...
            if (this.length) for (var e, i, s = r(this[0]); s.length && s[0] !== document;) {
    ...
    o.cleanData ? (s = o.cleanData, o.cleanData = function (t) {
        ...
        o.fn[a] = function (i) {
            ...
            return i = !t && s.length ? o.extend.apply(null, [!0, i].concat(s)) : i, t && "_" === i.charAt(0) || (t ? this.each(function () {
                var t = o.data(this, a), e = t && o.isFunction(t[i]) ? t[i].apply(t, s) : t;
        ...
        widgetName: "widget", widgetEventPrefix: "", options: {disabled: !1}, _createWidget: function (t, e) {
            ...
            if (i = i || {}, (e = o.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], n = e.originalEvent) for (s in n) s in e || (e[s] = n[s]);
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        start: function (t, e) {
            var i = b(e.helper), e = b(this).data("draggable").options;
        ...
        start: function (t, e) {
            var i, s = b(this).data("draggable").options, s = b.makeArray(b(s.stack)).sort(function (t, e) {
    ...
    p.widget("ui.droppable", {
        ...
        var s = (t.positionAbs || t.position.absolute).left, n = s + t.helperProportions.width,
            a = (t.positionAbs || t.position.absolute).top, o = a + t.helperProportions.height, r = e.offset.left,
            l = r + e.proportions.width, h = e.offset.top, c = h + e.proportions.height;
        switch (i) {
            case"fit":
        ...
        current: null, droppables: {default: []}, prepareOffsets: function (t, e) {
            ...
            t:for (var a = 0; a < i.length; a++) if (!(i[a].options.disabled || t && !i[a].accept.call(i[a].element[0], t.currentItem || t.element))) {
                for (var o = 0; o < n.length; o++) if (n[o] == i[a].element[0]) {
    ...
    c.widget("ui.resizable", c.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element.addClass("ui-resizable"), c.extend(this, {
                ...
                zoom: 1,
                display: "block"
            })), this.originalElement.css({margin: this.originalElement.css("margin")}), this._proportionallyResize()), this.handles = t.handles || (c(".ui-resizable-handle", this.element).length ? {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
                ...
                for (var s = 0; s < i.length; s++) {
                    ...
                    a.css({zIndex: t.zIndex}), "se" == n && a.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[n] = ".ui-resizable-" + n, this.element.append(a)
                }
            }
        ...
        _mouseStart: function (t) {
            ...
            var n = h(this.helper.css("left")), i = h(this.helper.css("top"));
            e.containment && (n += c(e.containment).scrollLeft() || 0, i += c(e.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                ...
                width: s.width(),
                height: s.height()
            }, this.originalPosition = {left: n, top: i}, this.sizeDiff = {
        ...
        _mouseDrag: function (t) {
            var e = this.helper, i = (this.options, this.originalMousePosition), s = this.axis,
                n = t.pageX - i.left || 0, i = t.pageY - i.top || 0, s = this._change[s];
            if (!s) return !1;
        ...
        _respectSize: function (t, e) {
            ...
            var l = this.originalPosition.left + this.originalSize.width, h = this.position.top + this.size.height,
                e = /sw|nw|w/.test(s), s = /nw|ne|n/.test(s);
    ...
    }), c.extend(c.ui.resizable, {version: "1.8.22"}), c.ui.plugin.add("resizable", "alsoResize", {
        start: function (t, e) {
            function i(t) {
                c(t).each(function () {
                    var t = c(this);
            ...
            function i(t, i) {
                c(t).each(function () {
                    var t = c(this), s = c(this).data("resizable-alsoresize"), n = {},
            ...
            var e = c(this).data("resizable"), s = e.options, n = e.originalSize, o = e.originalPosition, r = {
        ...
        stop: function (e, t) {
            var i = c(this).data("resizable"), s = i.options, n = i._proportionallyResizeElements,
                a = n.length && /textarea/i.test(n[0].nodeName),
                o = a && c.ui.hasScroll(n[0], "left") ? 0 : i.sizeDiff.height, r = a ? 0 : i.sizeDiff.width,
            ...
            i.element.animate(c.extend(a, o && r ? {top: o, left: r} : {}), {
        ...
        start: function (t, e) {
            var i, s, n = c(this).data("resizable"), a = n.options, o = n.element, r = a.containment,
            ...
            var i = c(this).data("resizable"), s = i.options, n = (i.containerSize, i.containerOffset),
                a = (i.size, i.position), o = i._aspectRatio || t.shiftKey, r = {top: 0, left: 0},
            ...
            var i = c(this).data("resizable"), s = i.options, n = (i.position, i.containerOffset),
                a = i.containerPosition, o = i.containerElement, r = c(i.helper), l = r.offset(),
                h = r.outerWidth() - i.sizeDiff.width, r = r.outerHeight() - i.sizeDiff.height;
        ...
        start: function (t, e) {
            var i = c(this).data("resizable"), s = i.options, n = i.size;
        ...
        resize: function (t, e) {
            var i = c(this).data("resizable"), s = i.options, n = i.size, a = i.originalSize, o = i.originalPosition,
                r = i.axis;
    ...
    h.widget("ui.selectable", h.ui.mouse, {
        ...
        _mouseDrag: function (i) {
            ...
            if (this.dragged = !0, !this.options.disabled) {
                var t, n = this.options, a = this.opos[0], o = this.opos[1], r = i.pageX, l = i.pageY;
    ...
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        _mouseDrag: function (t) {
            ...
            for (var s = this.items.length - 1; 0 <= s; s--) {
                var n = this.items[s], a = n.item[0], o = this._intersectsWithPointer(n);
        ...
        _intersectsWithPointer: function (t) {
            var e = "x" === this.options.axis || d.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                ...
                t = e && i, e = this._getDragVerticalDirection(), i = this._getDragHorizontalDirection();
        ...
        _getItemsAsjQuery: function (t) {
            ...
            if (s && t) for (var n = s.length - 1; 0 <= n; n--) for (var a = d(s[n]), o = a.length - 1; 0 <= o; o--) {
        ...
        _refreshItems: function (t) {
            ...
            var e = this.items,
                ...
                s = this._connectWith();
            if (s && this.ready) for (var n = s.length - 1; 0 <= n; n--) for (var a = d(s[n]), o = a.length - 1; 0 <= o; o--) {
                var r = d.data(a[o], this.widgetName);
            ...
            for (n = i.length - 1; 0 <= n; n--) for (var l = i[n][1], h = i[n][0], o = 0, c = h.length; o < c; o++) {
                var u = d(h[o]);
    ...
    h.effects.animateClass = function (a, o, r, l) {
        return h.isFunction(r) && (l = r, r = null), this.queue(function () {
            ...
            h.each(d, function (t, e) {
                ...
                queue: !1, duration: o, easing: r, complete: function () {
                    h.each(d, function (t, e) {
                        a[e] && i[e + "Class"](a[e])
        ...
        _addClass: h.fn.addClass, addClass: function (t, e, i, s) {
            ...
            return "boolean" == typeof e || e === o ? i ? h.effects.animateClass.apply(this, [e ? {add: t} : {remove: t}, i, s, n]) : this._toggleClass(t, e) : h.effects.animateClass.apply(this, [{toggle: t}, e, i, s])
        ...
        effect: function (t, e, i, s) {
            var n = r.apply(this, arguments), a = {options: n[1], duration: n[2], callback: n[3]}, o = a.options.mode,
                n = h.effects[t];
    ...
    l.effects.blind = function (r) {
        return this.queue(function () {
            var t = l(this), e = ["position", "top", "bottom", "left", "right"],
                i = l.effects.setMode(t, r.options.mode || "hide"), s = r.options.direction || "vertical";
            l.effects.save(t, e), t.show();
            var n = l.effects.createWrapper(t).css({overflow: "hidden"}), a = "vertical" == s ? "height" : "width",
    ...
    f.effects.bounce = function (p) {
        return this.queue(function () {
            var t = f(this), e = ["position", "top", "bottom", "left", "right"],
                ...
                n = p.options.distance || 20, a = p.options.times || 5, o = p.duration || 250;
            /show|hide/.test(i) && e.push("opacity"), f.effects.save(t, e), t.show(), f.effects.createWrapper(t);
            var r = "up" == s || "down" == s ? "top" : "left", l = "up" == s || "left" == s ? "pos" : "neg",
                n = p.options.distance || ("top" == r ? t.outerHeight(!0) / 3 : t.outerWidth(!0) / 3);
            "show" == i && t.css("opacity", 0).css(r, "pos" == l ? -n : n), "hide" == i && (n /= 2 * a), "hide" != i && a--, "show" == i && ((h = {opacity: 1})[r] = ("pos" == l ? "+=" : "-=") + n, t.animate(h, o / 2, p.options.easing), n /= 2, a--);
            for (var h, c = 0; c < a; c++) {
                var u, d = {};
                (u = {})[r] = ("pos" == l ? "-=" : "+=") + n, d[r] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, o / 2, p.options.easing).animate(d, o / 2, p.options.easing), n = "hide" == i ? 2 * n : n / 2
            }
            "hide" == i ? ((h = {opacity: 0})[r] = ("pos" == l ? "-=" : "+=") + n, t.animate(h, o / 2, p.options.easing, function () {
    ...
    l.effects.clip = function (r) {
        return this.queue(function () {
            var t = l(this), e = ["position", "top", "bottom", "left", "right", "height", "width"],
                i = l.effects.setMode(t, r.options.mode || "hide"), s = r.options.direction || "vertical";
            l.effects.save(t, e), t.show();
            var n = l.effects.createWrapper(t).css({overflow: "hidden"}), a = "IMG" == t[0].tagName ? n : t,
                o = {size: "vertical" == s ? "height" : "width", position: "vertical" == s ? "top" : "left"},
    ...
    h.effects.explode = function (l) {
        return this.queue(function () {
            ...
            for (var n = i.outerWidth(!0), a = i.outerHeight(!0), o = 0; o < t; o++) for (var r = 0; r < e; r++) i.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: n / e * -r,
                top: a / t * -o
    ...
    u.effects.fold = function (c) {
        return this.queue(function () {
            var t = u(this), e = ["position", "top", "bottom", "left", "right"],
                i = u.effects.setMode(t, c.options.mode || "hide"), s = c.options.size || 15,
                n = !!c.options.horizFirst, a = c.duration ? c.duration / 2 : u.fx.speeds._default / 2;
            u.effects.save(t, e), t.show();
            var o = u.effects.createWrapper(t).css({overflow: "hidden"}), r = "show" == i != n,
                l = r ? ["width", "height"] : ["height", "width"],
                h = r ? [o.width(), o.height()] : [o.height(), o.width()], r = /([0-9]+)%/.exec(s);
    ...
    a.effects.highlight = function (n) {
        return this.queue(function () {
            var t = a(this), e = ["backgroundImage", "backgroundColor", "opacity"],
                i = a.effects.setMode(t, n.options.mode || "show"), s = {backgroundColor: t.css("backgroundColor")};
    ...
    l.effects.pulsate = function (r) {
        return this.queue(function () {
            var t = l(this), e = l.effects.setMode(t, r.options.mode || "show"), i = 2 * (r.options.times || 5) - 1,
                s = r.duration ? r.duration / 2 : l.fx.speeds._default / 2, n = t.is(":visible"), a = 0;
            n || (t.css("opacity", 0).show(), a = 1), ("hide" == e && n || "show" == e && !n) && i--;
            for (var o = 0; o < i; o++) t.animate({opacity: a}, s, r.options.easing), a = (a + 1) % 2;
            t.animate({opacity: a}, s, r.options.easing, function () {
    ...
    f.effects.puff = function (a) {
        return this.queue(function () {
            var t = f(this), e = f.effects.setMode(t, a.options.mode || "hide"),
                i = parseInt(a.options.percent, 10) || 150, s = i / 100, n = {height: t.height(), width: t.width()};
            f.extend(a.options, {
                fade: !0,
                mode: e,
        ...
        return this.queue(function () {
            var t = f(this), e = f.extend(!0, {}, r.options), i = f.effects.setMode(t, r.options.mode || "effect"),
                s = parseInt(r.options.percent, 10) || (0 == parseInt(r.options.percent, 10) || "hide" == i ? 0 : 100),
                n = r.options.direction || "both", a = r.options.origin;
            "effect" != i && (e.origin = a || ["middle", "center"], e.restore = !0);
            var o = {height: t.height(), width: t.width()};
            t.from = r.options.from || ("show" == i ? {height: 0, width: 0} : o);
        ...
        return this.queue(function () {
            var s, t = f(this),
                ...
                i = ["position", "top", "bottom", "left", "right", "overflow", "opacity"], n = ["fontSize"],
                ...
                h = p.options.scale || "both", c = p.options.origin, u = {height: t.height(), width: t.width()};
            ...
            "box" != h && "both" != h || (d.from.y != d.to.y && (e = e.concat(a), t.from = f.effects.setTransition(t, a, d.from.y, t.from), t.to = f.effects.setTransition(t, a, d.to.y, t.to)), d.from.x != d.to.x && (e = e.concat(o), t.from = f.effects.setTransition(t, o, d.from.x, t.from), t.to = f.effects.setTransition(t, o, d.to.x, t.to))), "content" != h && "both" != h || d.from.y == d.to.y || (e = e.concat(n), t.from = f.effects.setTransition(t, n, d.from.y, t.from), t.to = f.effects.setTransition(t, n, d.to.y, t.to)), f.effects.save(t, l ? e : i), t.show(), f.effects.createWrapper(t), t.css("overflow", "hidden").css(t.from), "content" != h && "both" != h || (a = a.concat(["marginTop", "marginBottom"]).concat(n), o = o.concat(["marginLeft", "marginRight"]), s = e.concat(a).concat(o), t.find("*[width]").each(function () {
                ...
                t.from = {height: e * d.from.y, width: i * d.from.x}, t.to = {
                    height: e * d.to.y,
                    width: i * d.to.x
    ...
    d.effects.shake = function (u) {
        return this.queue(function () {
            var t = d(this), e = ["position", "top", "bottom", "left", "right"],
                ...
                s = u.options.distance || 20, n = u.options.times || 3, a = u.duration || u.options.duration || 140;
            d.effects.save(t, e), t.show(), d.effects.createWrapper(t);
            var o = "up" == i || "down" == i ? "top" : "left", r = "up" == i || "left" == i ? "pos" : "neg", i = {},
                l = {}, h = {};
    ...
    l.effects.slide = function (r) {
        return this.queue(function () {
            var t = l(this), e = ["position", "top", "bottom", "left", "right"],
                i = l.effects.setMode(t, r.options.mode || "show"), s = r.options.direction || "left";
    ...
    a.effects.transfer = function (n) {
        return this.queue(function () {
            var t = a(this), e = a(n.options.to), i = e.offset(),
                i = {top: i.top, left: i.left, height: e.innerHeight(), width: e.innerWidth()}, e = t.offset(),
    ...
    c.widget("ui.accordion", {
        options: {
            ...
            if (!(this.options.disabled || t.altKey || t.ctrlKey)) {
                var e = c.ui.keyCode, i = this.headers.length, s = this.headers.index(t.target), n = !1;
                switch (t.keyCode) {
                    case e.RIGHT:
                    case e.DOWN:
            ...
            a._trigger("changestart", null, a.data), a.running = (0 === e.size() ? t : e).size(), o.animated ? (i = {}, i = o.collapsible && s ? {
                ...
                this.slide(t, {easing: h, duration: l || 700})
            ...
            slide: function (s, t) {
                ...
                (s = c.extend({
                    ...
                    step: function (t, e) {
                        ...
                        s.autoHeight || s.toShow.css("height", ""), s.toShow.css({width: o, overflow: e}), s.complete()
                    }
                })) : s.toHide.animate({
                    height: "hide",
                    paddingTop: "hide",
        ...
        options: {
            ...
            this.isMultiLine = this.element.is("textarea"), this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({
                ...
                focus: function (t, e) {
                    ...
                    !1 !== n._trigger("focus", t, {item: e}) && /^key/.test(t.originalEvent.type) && n.element.val(e.value)
            ...
            return t.length && t[0].label && t[0].value ? t : o.map(t, function (t) {
                return "string" == typeof t ? {label: t, value: t} : o.extend({
            ...
            this._renderMenu(e, t), this.menu.deactivate(), this.menu.refresh(), e.show(), this._resizeMenu(), e.position(o.extend({of: this.element}, this.options.position)), this.options.autoFocus && this.menu.next(new o.Event("mouseover"))
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachDatepicker: function (target, settings) {
            var inlineSettings = null, attrName;
        ...
        _updateDatepicker: function (t) {
            ...
            var s, i = this._getNumberOfMonths(t), e = i[1];
        ...
        parseDate: function (e, n, t) {
            ...
            for (var r = "string" != typeof (r = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff) ? r : (new Date).getFullYear() % 100 + parseInt(r, 10), l = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, h = (t ? t.dayNames : null) || this._defaults.dayNames, c = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, u = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, p = -1, f = -1, g = -1, m = !1, v = 0, _ = 0; _ < e.length; _++) if (m) "'" != e.charAt(_) || a("'") ? o() : m = !1; else switch (e.charAt(_)) {
                case"d":
                    f = i("d");
                    break;
                case"D":
                ...
                case"y":
                    ...
                    break;
                case"@":
                    var b, d = (b = new Date(i("@"))).getFullYear(), p = b.getMonth() + 1, f = b.getDate();
                    break;
                case"!":
        ...
        formatDate: function (e, t, i) {
            ...
            var o = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                h = (i ? i.monthNames : null) || this._defaults.monthNames, c = "", u = !1;
            if (t) for (var d = 0; d < e.length; d++) if (u) "'" != e.charAt(d) || n("'") ? c += e.charAt(d) : u = !1; else switch (e.charAt(d)) {
                case"d":
                    c += s("d", t.getDate(), 2);
                    break;
                case"D":
        ...
        _setDateFromField: function (t, e) {
            if (t.input.val() != t.lastVal) {
                var i, s = this._get(t, "dateFormat"), n = t.lastVal = t.input ? t.input.val() : null,
                    a = i = this._getDefaultDate(t), o = this._getFormatConfig(t);
                try {
        ...
        _generateHTML: function (t) {
            var e = new Date, e = this._daylightSavingAdjust(new Date(e.getFullYear(), e.getMonth(), e.getDate())),
                ...
                a = this._get(t, "navigationAsDateFormat"), o = this._getNumberOfMonths(t),
                r = this._get(t, "showCurrentAtPos"), l = this._get(t, "stepMonths"), h = 1 != o[0] || 1 != o[1],
                ...
                f = t.drawYear;
            if (p < 0 && (p += 12, f--), d) for (var g = this._daylightSavingAdjust(new Date(d.getFullYear(), d.getMonth() - o[0] * o[1] + 1, d.getDate())), g = u && g < u ? u : g; this._daylightSavingAdjust(new Date(f, p, 1)) > g;) --p < 0 && (p = 11, f--);
            ...
            for (var r = this._get(t, "prevText"), r = a ? this.formatDate(r, this._daylightSavingAdjust(new Date(f, p - l, 1)), this._getFormatConfig(t)) : r, m = this._canAdjustMonth(t, -1, f, p) ? '<a class="ui-datepicker-prev ui-corner-all" data-handler="prev" data-event="click" title="' + r + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + r + "</span></a>" : n ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + r + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + r + "</span></a>", r = this._get(t, "nextText"), r = a ? this.formatDate(r, this._daylightSavingAdjust(new Date(f, p + l, 1)), this._getFormatConfig(t)) : r, v = this._canAdjustMonth(t, 1, f, p) ? '<a class="ui-datepicker-next ui-corner-all" data-handler="next" data-event="click" title="' + r + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + r + "</span></a>" : n ? "" : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' + r + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + r + "</span></a>", n = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? c : e, n = a ? this.formatDate(n, r, this._getFormatConfig(t)) : n, a = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>", a = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? a : "") + (this._isInRange(t, r) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + n + "</button>" : "") + (i ? "" : a) + "</div>" : "", _ = parseInt(this._get(t, "firstDay"), 10), _ = isNaN(_) ? 0 : _, b = this._get(t, "showWeek"), y = this._get(t, "dayNames"), w = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), k = this._get(t, "monthNames"), D = this._get(t, "monthNamesShort"), x = this._get(t, "beforeShowDay"), C = this._get(t, "showOtherMonths"), M = this._get(t, "selectOtherMonths"), I = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), F = "", S = 0; S < o[0]; S++) {
                ...
                this.maxRows = 4;
                for (var T = 0; T < o[1]; T++) {
                    var A = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)), z = " ui-corner-all", N = "";
                    if (h) {
                    ...
                    var R = (this._getFirstDayOfMonth(f, p) - _ + 7) % 7, W = Math.ceil((R + W) / 7),
                    ...
                    for (var Y = this._daylightSavingAdjust(new Date(f, p, 1 - R)), j = 0; j < L; j++) {
                        ...
                        for (var B = b ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(Y) + "</td>" : "", H = 0; H < 7; H++) {
                            var q = x ? x.apply(t.input ? t.input[0] : null, [Y]) : [!0, ""], K = Y.getMonth() != p,
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, a, o, r) {
            ...
            if (a || !l) d += '<span class="ui-datepicker-month">' + o[e] + "</span>"; else {
            ...
            if (c || (u += d + (!a && l && h ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", a || !h) u += '<span class="ui-datepicker-year">' + i + "</span>"; else {
                var m = this._get(t, "yearRange").split(":"), v = (new Date).getFullYear(), o = function (t) {
                        t = t.match(/c[+-].*/) ? i + parseInt(t.substring(1), 10) : t.match(/[+-].*/) ? v + parseInt(t, 10) : parseInt(t, 10);
                        return isNaN(t) ? v : t
                    }, _ = o(m[0]), b = Math.max(_, o(m[1] || "")), _ = s ? Math.max(_, s.getFullYear()) : _,
        ...
        _isInRange: function (t, e) {
            var i = this._getMinMaxDate(t, "min"), t = this._getMinMaxDate(t, "max");
    ...
    var l = "ui-dialog ui-widget ui-widget-content ui-corner-all ",
        a = {buttons: !0, height: !0, maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0, width: !0},
        o = {maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0},
        h = r.attrFn || {val: !0, css: !0, html: !0, text: !0, data: !0, width: !0, height: !0, offset: !0, click: !0};
    r.widget("ui.dialog", {
        options: {
            autoOpen: !0,
            buttons: {},
            ...
            var e = this, i = e.options, t = i.title || "&#160;", s = r.ui.dialog.getTitleId(e.element),
                n = (e.uiDialog = r("<div></div>")).appendTo(document.body).hide().addClass(l + i.dialogClass).css({zIndex: i.zIndex}).attr("tabIndex", -1).css("outline", 0).keydown(function (t) {
            ...
            if (!this._isOpen) {
                ...
                return t.overlay = e.modal ? new r.ui.dialog.overlay(t) : null, t._size(), t._position(e.position), i.show(e.show), t.moveToTop(!0), e.modal && i.bind("keydown.ui-dialog", function (t) {
                    if (t.keyCode === r.ui.keyCode.TAB) {
                        var e = r(":tabbable", this), i = e.filter(":first"), e = e.filter(":last");
            ...
            s.uiDialog.find(".ui-dialog-buttonpane").remove(), "object" == typeof t && null !== t && r.each(t, function () {
                ...
                e = r.isFunction(e) ? {click: e, text: t} : e;
            ...
            var s, n = this, a = n.options, o = r(document);
            ...
            t = t ? (("string" == typeof t || "object" == typeof t && "0" in t) && (1 === (i = t.split ? t.split(" ") : [t[0], t[1]]).length && (i[1] = i[0]), r.each(["left", "top"], function (t, e) {
                ...
                top: 0,
                left: 0
            }).position(r.extend({of: window}, t)), e || this.uiDialog.hide()
        }, _setOptions: function (t) {
            var i = this, s = {}, n = !1;
        ...
        destroy: function (t) {
            ...
            -1 != e && this.oldInstances.push(this.instances.splice(e, 1)[0]), 0 === this.instances.length && r([document, window]).unbind(".dialog-overlay"), t.remove();
            var i = 0;
    ...
    g.ui = g.ui || {};
    var i = /left|center|right/, s = /top|center|bottom/, m = "center", v = {}, n = g.fn.position, a = g.fn.offset;
    g.fn.position = function (h) {
        ...
        return g.each(["my", "at"], function () {
            ...
            var i, t = g(this), s = t.outerWidth(), n = t.outerHeight(),
                e = parseInt(g.curCSS(this, "marginLeft", !0)) || 0, a = parseInt(g.curCSS(this, "marginTop", !0)) || 0,
                o = s + e + (parseInt(g.curCSS(this, "marginRight", !0)) || 0),
                r = n + a + (parseInt(g.curCSS(this, "marginBottom", !0)) || 0), l = g.extend({}, f);
        ...
        var i = g(t), s = i.offset(), n = parseInt(g.curCSS(t, "top", !0), 10) || 0,
            a = parseInt(g.curCSS(t, "left", !0), 10) || 0, a = {top: e.top - s.top + n, left: e.left - s.left + a};
        ...
        var t, e, i = document.getElementsByTagName("body")[0], s = document.createElement("div"),
            n = document.createElement(i ? "div" : "body"),
            a = {visibility: "hidden", width: 0, height: 0, border: 0, margin: 0, background: "none"};
        for (e in i && g.extend(a, {position: "absolute", left: "-1000px", top: "-1000px"}), a) n.style[e] = a[e];
    ...
    c.widget("ui.slider", c.ui.mouse, {
        ...
        _refreshValue: function () {
            var i, s, t, e, n, a = this.options.range, o = this.options, r = this, l = !this._animateOff && o.animate,
                h = {};
            this.options.values && this.options.values.length ? this.handles.each(function (t, e) {
                i = (r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, h["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", c(this).stop(1, 1)[l ? "animate" : "css"](h, o.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === t && r.range.stop(1, 1)[l ? "animate" : "css"]({left: i + "%"}, o.animate), 1 === t && r.range[l ? "animate" : "css"]({width: i - s + "%"}, {
                    queue: !1,
                    duration: o.animate
                })) : (0 === t && r.range.stop(1, 1)[l ? "animate" : "css"]({bottom: i + "%"}, o.animate), 1 === t && r.range[l ? "animate" : "css"]({height: i - s + "%"}, {
                    queue: !1,
                    duration: o.animate
                }))), s = i
                ...
                queue: !1,
                duration: o.animate
            }), "min" === a && "vertical" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({height: i + "%"}, o.animate), "max" === a && "vertical" === this.orientation && this.range[l ? "animate" : "css"]({height: 100 - i + "%"}, {
                queue: !1,
                duration: o.animate
            }))
        }
    ...
    p.widget("ui.tabs", {
        options: {
            ...
            var s = this, n = this.options, a = p(n.tabTemplate.replace(/#\{href\}/g, t).replace(/#\{label\}/g, e)),
            ...
            s = this._getIndex(s);
            var t, n = this, a = this.options, o = this.anchors.eq(s)[0], e = p.data(o, "load.tabs");
    ...
    var o = 0, l = {}, r = {}, a = Array.prototype.slice, n = "disabled", h = "wizard", p = "default", f = "number",
        g = "boolean";
    u.each("branch form header step wrapper".split(" "), function () {
        ...
        _create: function () {
            var t, e, i = this, s = i.options, n = i.element, a = n.find(s.steps).eq(0).parent();
        ...
        _fastForward: function (s, n, a) {
            var o = 0, r = this, l = r._currentState.stepIndex, h = [l];
            u.isFunction(n) && (a = n, n = c), function i() {
        ...
        _find: function (t, e, i) {
            var s, n, a, o, r, l = [], h = e instanceof jQuery ? e : u(e);

            function c(t, e) {
                if (e === o) return s = e, !1
            }

            if (null !== t && h.length) for (n = 0, a = (t = d(t)).length; n < a; n++) s = null, (r = typeof (o = t[n])) == f ? s = h.get(o) : "string" == r ? s = document.getElementById(o.replace("#", "")) : "object" == r && (o instanceof jQuery && o.length && (o = o[0]), o.nodeType && h.each(c)), s && l.push(s);
            return !1 === i ? l : u(l)
        },
        _move: function (t, e, i, s, n) {
            var a = this, o = a._currentState;
        ...
        _transition: function (t, e, i) {
            ...
            var n = s.options, t = s.step(t, e), e = t.attr(n.stateAttribute),
                n = e ? n.transitions[e] : n.transitions[p], e = u.isFunction(n) ? n.call(s, t, function () {
    ...
    l.extend(l.fn, {
        validate: function (t) {
            ...
            var i = this[0];
            if (t) {
                var s = l.data(i.form, "validator").settings, n = s.rules, a = l.validator.staticRules(i);
                switch (t) {
                    case"add":
            ...
            return r.required && (t = r.required, delete r.required, r = l.extend({required: t}, r)), r
        }
    }), l.extend(l.expr[":"], {
        blank: function (t) {
        ...
        prototype: {
            init: function () {
                ...
                var t, i, s = l(e).rules(), n = !1, a = this.elementValue(e);
                for (i in s) {
                    var o = {method: i, parameters: s[i]};
                    try {
        ...
        attributeRules: function (t) {
            var e, i = {}, s = l(t), n = s[0].getAttribute("type");
        ...
        methods: {
            required: function (t, e, i) {
                ...
                for (var i = 0, s = 0, n = !1, a = (t = t.replace(/\D/g, "")).length - 1; 0 <= a; a--) {
                    var o = t.charAt(a), s = parseInt(o, 10);
                    n && 9 < (s *= 2) && (s -= 9), i += s, n = !n
                }
                return i % 10 == 0
                ...
                if (this.settings.messages[n.name] || (this.settings.messages[n.name] = {}), a.originalMessage = this.settings.messages[n.name].remote, this.settings.messages[n.name].remote = a.message, t = "string" == typeof t ? {url: t} : t, a.old === s) return a.valid;
                a.old = s;
                var o = this;
                this.startRequest(n);
                var e = {};
    ...
    k.cleanData = (n = k.cleanData, function (t) {
        ...
        }), n.prototype = k.widget.extend(a, {widgetEventPrefix: s && a.widgetEventPrefix || t}, o, {
            constructor: n,
            namespace: r,
            widgetName: t,
            widgetFullName: l
        ...
        for (var e, i, s = r.call(arguments, 1), n = 0, a = s.length; n < a; n++) for (e in s[n]) i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (k.isPlainObject(i) ? t[e] = k.isPlainObject(t[e]) ? k.widget.extend({}, t[e], i) : k.widget.extend({}, i) : t[e] = i);
        return t
    ...
    }, k.each({show: "fadeIn", hide: "fadeOut"}, function (a, o) {
        k.Widget.prototype["_" + a] = function (e, t, i) {
            var s;
            "string" == typeof t && (t = {effect: t});
            var n = t ? !0 !== t && "number" != typeof t && t.effect || o : a;
            "number" == typeof (t = t || {}) && (t = {duration: t}), s = !k.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && k.effects && k.effects.effect[n] ? e[a](t) : n !== a && e[n] ? e[n](t.duration, t.easing, i) : e.queue(function (t) {
    ...
    D = Math.max, x = Math.abs, a = /left|center|right/, o = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, h = /^\w+/, c = /%$/, C = k.fn.position, k.position = {
        ...
        u = k.extend({}, u);
        var d, p, f, g, m, t, v = k(u.of), _ = k.position.getWithinInfo(u.within), b = k.position.getScrollInfo(_),
            y = (u.collision || "flip").split(" "), w = {}, e = 9 === (t = (e = v)[0]).nodeType ? {
                width: e.width(),
                height: e.height(),
                offset: {top: 0, left: 0}
            } : k.isWindow(t) ? {
        ...
        return v[0].preventDefault && (u.at = "left top"), p = e.width, f = e.height, g = e.offset, m = k.extend({}, g), k.each(["my", "at"], function () {
            ...
            var i, t, o = k(this), r = o.outerWidth(), l = o.outerHeight(), e = I(this, "marginLeft"),
                s = I(this, "marginTop"), n = r + e + I(this, "marginRight") + b.width,
                a = l + s + I(this, "marginBottom") + b.height, h = k.extend({}, m),
    ...
    "1.7" === k.fn.jquery.substring(0, 3) && (k.each(["Width", "Height"], function (t, i) {
        var n = "Width" === i ? ["Left", "Right"] : ["Top", "Bottom"], s = i.toLowerCase(), a = {
    ...
    k.extend(k.ui, {datepicker: {version: "1.12.1"}}), k.extend(d.prototype, {
        markerClassName: "hasDatepicker",
        maxRows: 4,
        _widgetDatepicker: function () {
            return this.dpDiv
        ...
        _doKeyDown: function (t) {
            var e, i, s = k.datepicker._getInst(t.target), n = !0, a = s.dpDiv.is(".ui-datepicker-rtl");
        ...
        parseDate: function (e, n, t) {
            ...
            function s(t, e, i) {
                var s = -1, e = k.map(a(t) ? i : e, function (t, e) {
                    return [[e, t]]
                }).sort(function (t, e) {
                    return -(t[1].length - e[1].length)
                });
            ...
            if (-1 === m ? m = (new Date).getFullYear() : m < 100 && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (m <= u ? 0 : -100)), -1 < b) for (v = 1, _ = b; ;) {
        ...
        formatDate: function (e, t, i) {
            ...
            if (t) for (o = 0; o < e.length; o++) if (d) "'" !== e.charAt(o) || n("'") ? u += e.charAt(o) : d = !1; else switch (e.charAt(o)) {
                case"d":
                    u += s("d", t.getDate(), 2);
                    break;
                case"D":
        ...
        _generateHTML: function (t) {
            var e, i, s, n, a, o, r, l, h, c, u, d, p, f, g, m, v, _, b, y, w, k, D, x, C, M, I, F, S, P, T, A,
                z = new Date, N = this._daylightSavingAdjust(new Date(z.getFullYear(), z.getMonth(), z.getDate())),
                E = this._get(t, "isRTL"), H = this._get(t, "showButtonPanel"), O = this._get(t, "hideIfNoPrevNext"),
                W = this._get(t, "navigationAsDateFormat"), $ = this._getNumberOfMonths(t),
                R = this._get(t, "showCurrentAtPos"), z = this._get(t, "stepMonths"), L = 1 !== $[0] || 1 !== $[1],
                Y = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) : new Date(9999, 9, 9)),
                j = this._getMinMaxDate(t, "min"), B = this._getMinMaxDate(t, "max"), q = t.drawMonth - R,
                K = t.drawYear;
            if (q < 0 && (q += 12, K--), B) for (e = this._daylightSavingAdjust(new Date(B.getFullYear(), B.getMonth() - $[0] * $[1] + 1, B.getDate())), e = j && e < j ? j : e; this._daylightSavingAdjust(new Date(K, q, 1)) > e;) --q < 0 && (q = 11, K--);
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, a, o, r) {
            var l, h, c, u, d, p, f, g = this._get(t, "changeMonth"), m = this._get(t, "changeYear"),
                v = this._get(t, "showMonthAfterYear"), _ = "<div class='ui-datepicker-title'>", b = "";
            if (a || !g) b += "<span class='ui-datepicker-month'>" + o[e] + "</span>"; else {
            ...
            if (v || (_ += b + (!a && g && m ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", a || !m) _ += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
...
var CryptoJS = CryptoJS || function (h) {
    ...
    var c = e.WordArray = i.extend({
        init: function (t, e) {
            ...
            var e = this.words, i = t.words, s = this.sigBytes, n = t.sigBytes;
            if (this.clamp(), s % 4) for (var a = 0; a < n; a++) {
                var o = i[a >>> 2] >>> 24 - a % 4 * 8 & 255;
                e[s + a >>> 2] |= o << 24 - (s + a) % 4 * 8
            } else if (65535 < i.length) for (a = 0; a < n; a += 4) e[s + a >>> 2] = i[a >>> 2]; else e.push.apply(e, i);
        ...
        reset: function () {
            ...
            var e = this._data, i = e.words, s = e.sigBytes, n = this.blockSize, a = s / (4 * n),
                o = (a = t ? h.ceil(a) : h.max((0 | a) - this._minBufferSize, 0)) * n, s = h.min(4 * o, s);
            if (o) {
...
!function (l) {
    var t = CryptoJS, e = (s = t.lib).WordArray, i = s.Hasher, s = t.algo, M = [];
    ...
    !function () {
        ...
        _doReset: function () {
            ...
            var a = this._hash.words, o = t[e + 0], r = t[e + 1], l = t[e + 2], h = t[e + 3], c = t[e + 4],
                u = t[e + 5], d = t[e + 6], p = t[e + 7], f = t[e + 8], g = t[e + 9], m = t[e + 10], v = t[e + 11],
                _ = t[e + 12], b = t[e + 13], y = t[e + 14], w = t[e + 15],
                k = I(k = a[0], C = a[1], x = a[2], D = a[3], o, 7, M[0]), D = I(D, k, C, x, r, 12, M[1]),
                x = I(x, D, k, C, l, 17, M[2]), C = I(C, x, D, k, h, 22, M[3]);
            ...
            var t = this._data, e = t.words, i = 8 * this._nDataBytes, s = 8 * t.sigBytes;
            e[s >>> 5] |= 128 << 24 - s % 32;
            var n = l.floor(i / 4294967296), i = i;
